...
watch(groupedData, (newValue) => {
  newValue.forEach(val => {
    ...
    if (digits) {
      val.phoneNum = digits.substring(0, 10)
        .replace(/^(\d{0,3})$/, '($1')
...
<template>
  <div class="mainWrapper">
    ...
    <div style="margin-bottom: 20px; border: 1px solid #ccc; padding: 15px; border-radius: 8px;" class="inputWrapper">
      ...
      <div v-for="(grp, index) in groupedData" :key="index">
        <div style="margin-bottom: 10px;">
          ...
          <input placeholder="Phone Number" v-model="grp.phoneNum"
        ...
        <div style="margin-bottom: 10px;">
          ...
          <input type="text" placeholder="Email" v-model="grp.email" pattern='[A-Za-z\\s]*'
            style="width: calc(100% - 15px); padding: 8px; margin-top: 5px;" />
        ...
        <div style="margin-bottom: 10px;">
          <label>Name:</label><br />
          <input v-model="grp.userName" placeholder="Full Name"
            style="width: calc(100% - 15px); padding: 8px; margin-top: 5px;" />
        ...
        <div style="display: flex; gap: 10px;">
          ...
          <button v-if="groupedData.length > 2" @click="removeField(index)"
    ...
    <table v-if="formData.length" style="width: 100%; margin-top: 20px; border-collapse: collapse;"
      class="tableContentHolder">
      <thead>
        <tr>
